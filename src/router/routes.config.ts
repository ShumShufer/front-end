...
export const ROUTES = {
  ...
  student: {
    ...
    classroomHub: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}`,
    classroomFeed: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/feed`,
    classroomCourses: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/courses`,
    classroomResources: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/resources`,
    classroomTasks: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/tasks`,
    classroomSchedule: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/schedule`,
    classroomAttendance: (classroomId = ':classroomId') => `/app/student/classroom/${classroomId}/attendance`,
    coursePlayer: (courseId = ':courseId') => `/app/student/courses/${courseId}`,
    courseExam: (courseId = ':courseId') => `/app/student/courses/${courseId}/exam`,
  ...
  mentor: {
    ...
    classroomHub: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}`,
    announcements: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/announcements`,
    ...
    tasks: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/tasks`,
    taskEdit: (taskId = ':taskId') => `/app/mentor/tasks/${taskId}`,
    grading: (submissionId = ':submissionId') => `/app/mentor/submissions/${submissionId}/grade`,
    publishResults: (courseId = ':courseId') => `/app/mentor/courses/${courseId}/publish-results`,
    schedule: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/schedule`,
    attendance: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/attendance`,
    reportStudent: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/report`,
    resources: (classroomId = ':classroomId') => `/app/mentor/classrooms/${classroomId}/resources`,
