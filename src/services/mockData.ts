...
export const mockStaffPosts: StaffApplicationPost[] = [
  {
    ...
    role: Role.MENTOR,
    description:
      "Seeking an experienced driving instructor for our Bole branch.",
    status: "OPEN",
...
export const mockApplicationFormTemplates: ApplicationFormTemplate[] = [
  {
    ...
    fields: [
      ...
      {
        key: "hasLicense",
        label: "Do you have a learner permit?",
        type: "boolean",
        required: true,
      },
      {
...
export const mockScheduleEvents: ScheduleEvent[] = [
  {
    ...
    location: "Bole Branch Hall",
  },
  {
    id: "event-current-classroom-1",
    schoolId: "school-1",
    classroomId: "classroom-1",
    scope: ScheduleScope.CLASSROOM,
    createdByRole: Role.MENTOR,
    title: "Practical road session",
    startTime: "2026-08-23T07:30:00Z",
    endTime: "2026-08-23T10:00:00Z",
...
export const mockTopics: Topic[] = [
  {
    ...
    order: 1,
    content:
      "In this topic, we explore the most common Ethiopian road signs and their meanings.",
  },
  {
    id: "topic-2",
    courseId: "course-1",
    ...
    order: 2,
    content:
      "Understanding right of way is essential for safe driving. We cover intersections, roundabouts, and merging.",
  },
  {
    id: "topic-3",
    courseId: "course-2",
    ...
    order: 1,
    content:
      "Introduction to accelerator, brake, steering, and gear selector in automatic vehicles.",
  },
  {
    id: "topic-4",
    courseId: "course-2",
    ...
    order: 2,
    content:
      "Techniques for parallel parking, reverse parking, and three-point turns.",
  },
];
...
export const mockTasks: Task[] = [
  ...
  },
  {
    ...
    description:
      "Covers topics 1 and 2. Duration is 90 minutes. Passing score is 70%.",
    attachments: [],
