...
export const TaskProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const loadTasks = useCallback(async (classroomId: string) => {
    ...
    try {
      ...
      dispatch({
        type: "FETCH_ERROR",
        payload: getErrorMessage(error, "Failed to load tasks"),
      });
    }
  }, []);
  ...
  const loadTaskById = useCallback(async (id: string) => {
    ...
    try {
      ...
      dispatch({
        type: "FETCH_ERROR",
        payload: getErrorMessage(error, "Failed to load task"),
      });
    }
  }, []);

  const createTask = useCallback(
    async (classroomId: string, data: Partial<Task>) => {
      dispatch({ type: "FETCH_START" });
      try {
        ...
        dispatch({
          type: "FETCH_ERROR",
          payload: getErrorMessage(error, "Failed to create task"),
        });
        throw error;
      }
    },
  ...
  const updateTask = useCallback(async (id: string, data: Partial<Task>) => {
    ...
    try {
      ...
      dispatch({
        type: "FETCH_ERROR",
        payload: getErrorMessage(error, "Failed to update task"),
      });
      throw error;
    }
  }, []);
  ...
  const deleteTask = useCallback(async (id: string) => {
    ...
    try {
      ...
      dispatch({
        type: "FETCH_ERROR",
        payload: getErrorMessage(error, "Failed to delete task"),
      });
      throw error;
    }
  }, []);
  ...
  const loadSubmissions = useCallback(async (taskId: string) => {
    ...
    try {
      ...
      dispatch({
        type: "FETCH_ERROR",
        payload: getErrorMessage(error, "Failed to load submissions"),
      });
    }
  }, []);

  const submitTask = useCallback(
    async (taskId: string, studentId: string, attachments: string[]) => {
      dispatch({ type: "FETCH_START" });
      try {
        ...
        dispatch({
          type: "FETCH_ERROR",
          payload: getErrorMessage(error, "Failed to submit task"),
        });
        throw error;
      }
    },
  ...
  const gradeSubmission = useCallback(
    async (submissionId: string, grade: number, feedback: string) => {
      ...
      try {
        ...
        dispatch({
          type: "FETCH_ERROR",
          payload: getErrorMessage(error, "Failed to grade submission"),
        });
        throw error;
      }
    },
