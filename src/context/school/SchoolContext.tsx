...
export interface SchoolContextType extends SchoolState {
  ...
  assignClassroomMentor: (classroomId: string, mentorId: string) => Promise<void>;
  removeClassroomMentor: (classroomId: string, mentorId: string) => Promise<void>;
  loadStaffPosts: (schoolId: string) => Promise<void>;
  addStaffPost: (schoolId: string, role: Role, description: string) => Promise<void>;
  updateStaffPost: (id: string, data: Partial<StaffApplicationPost>) => Promise<void>;
  removeStaffPost: (id: string) => Promise<void>;
  loadStaffApplications: (schoolId: string) => Promise<void>;
  updateStaffApplication: (id: string, status: ApplicationStatus) => Promise<void>;
